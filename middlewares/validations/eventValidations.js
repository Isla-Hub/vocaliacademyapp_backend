...
const updateEventValidation = [
  ...
  body("instructedBy")
    .optional()
    .notEmpty()
    .withMessage("The instructedBy field cannot be empty.")
    .isMongoId()
    .withMessage("The instructedBy field must be a valid MongoDB ObjectId."),
  body("room")
    .optional()
  ...
  body("eventGroupSize")
    .optional()
    .notEmpty()
    .withMessage("The eventGroupSize field cannot be empty.")
    .isInt({ min: 0 })
    .withMessage("The eventGroupSize field must be a positive integer."),
  body("totalAttended")
    .optional()
    .notEmpty()
    .withMessage("The totalAttended field cannot be empty.")
    .isInt({ min: 0 })
    .withMessage("The totalAttended field must be a positive integer."),
  body("isPublic")
    .optional()
    .notEmpty()
    .withMessage("The isPublic field cannot be empty.")
    .isBoolean()
    .withMessage("The isPublic field must be a boolean value."),
  body("categories")
    .optional()
    .notEmpty()
    .withMessage("The categories field cannot be empty.")
    .isArray({ min: 1 })
    .withMessage(
      "The categories field must be an array with at least one element."
    )
  ...
  body("level")
    .optional()
    .notEmpty()
    .withMessage("The level field cannot be empty.")
    .isIn(["beginner", "intermediate", "advanced"])
    .withMessage(
      "The level field must have one of the following values: beginner, intermediate, advanced."
    )
  ...
  body("internalPrice")
    .optional()
    .notEmpty()
    .withMessage("The internalPrice field cannot be empty.")
    .isFloat({ min: 0 })
    .withMessage("The internalPrice field must be a positive number."),
  body("externalPrice")
    .optional()
    .notEmpty()
    .withMessage("The externalPrice field cannot be empty.")
    .isFloat({ min: 0 })
    .withMessage("The externalPrice field must be a positive number."),
  body("internalAtendants")
    .optional()
